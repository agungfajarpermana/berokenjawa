...
<body>
    ...
    <div class="container container-card">
      <div class="row">
        <div class="col s12 m12" id="alert-success" style="display:none">
        ...
        <div class="col s12 m12" id="alert-danger" style="display:none">
          <div class="card-panel red darken-4">
            <span class="white-text danger">
              <!-- output -->
            </span>
          </div>
        </div>
        <div class="col s12 m12">
          <div class="card transparent">
            <div class="card-content white-text">
              ...
              <div class="row">
                <form action="#" class="col s12" id="forgot_pass">
                  <div class="row">
                    <div class="input-field col s12">
                      <input id="email" type="email" name="email" class="input">
                      <label for="email">Your Mail</label>
                      <span class="helper-text email" data-error="wrong"></span>
                    </div>
                  </div>
                  <button class="btn waves-effect waves-light" type="submit" id="forgot">
                    send mail
                  </button>
                  <a href="{{route('login.form')}}" class="right orange-text text-darken-4">back to login</a>
                  {{csrf_field()}}
                </form>
              </div>
            </div>
